...
db.onConnected = function(database)
	...
	ES.DBQuery("SELECT `table_name` FROM information_schema.tables WHERE `table_schema` = '"..DATABASE_SCHEMA.."';",function(res)
		...
		if notFound then
			...
			ES.DBQuery("CREATE TABLE IF NOT EXISTS `es_servers` ( `id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT, ip varchar(100), port int(16) unsigned default 27015, dns varchar(100), name varchar(100), game varchar(100), PRIMARY KEY (`id`), UNIQUE KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1"):wait()
