...
if SERVER then
	...
	hook.Add("ESPreCreateDatatables","w0wu9uwddwdwdwdwdww09dy0928y09h2",function()
		ES:DefineDataTable("restrictions_props",false,"model varchar(255), serverid varchar(255), req int(8)");
	end)
