...
elseif CLIENT then
	...
	net.Receive("exclBP",function()
		...
		if t > 0 then	
			chat.AddText("admincommand",Color(255,255,255),exclFixCaps(p:ESGetRank().name).." ",Color(102,255,51),p:Nick(),Color(255,255,255)," has banned ",Color(102,255,51),v,ES.Color.White, " for ",Color(102,255,51),string.ToMinutesSeconds(tostring(t)),ES.Color.White," hours with reason: "..(r or "No reason specified.")..".")
		else
			chat.AddText("admincommand",Color(255,255,255),exclFixCaps(p:ESGetRank().name).." ",Color(102,255,51),p:Nick(),Color(255,255,255)," has banned ",Color(102,255,51),v,ES.Color.White, " permanently with reason: "..(r or "No reason specified.")..".")
		end
		chat.PlaySound()
	end)
	net.Receive("exclUBP",function()
		...
		if not IsValid(p) then return end
		chat.AddText("admincommand",Color(255,255,255),exclFixCaps(p:ESGetRank().name).." ",Color(102,255,51),p:Nick(),Color(255,255,255)," has unbanned ",Color(102,255,51),ub,ES.Color.White, ".")
		chat.PlaySound()
	end)
end