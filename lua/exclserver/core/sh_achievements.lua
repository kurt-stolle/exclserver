...
ES:DefineAchievement("bananas_count", "Banana bunch millionaire", "Gain over 100.000 bananas.\n(Yes, I know 100.000 is not really a million.)", 100000, Material("excl/achies/banana.png"),false,true,false);
